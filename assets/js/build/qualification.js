...
export function createQualificationSection() {
  ...
  const educationTab = createElement(
    "div",
  ...
  const createQualificationStructure = (items) => {
    return items.map((item, index) => {
      ...
      return createQualificationItem(
        item.title,
        item.subtitle,
        item.dateRange,
        index,
  ...
  const educationContent = createElement(
    "div",
  ...
  setTimeout(() => {
    ...
    qualificationButtons.forEach((button) => {
      button.addEventListener("click", function () {
        document
          .querySelector(".qualification__button.qualification__active")
          .classList.remove("qualification__active");
        this.classList.add("qualification__active");
        document
          .querySelector(".qualification__content.qualification__active")
          .classList.remove("qualification__active");
        document
